...
if __name__ == "__main__":
    ann_file = "/data/DigitalBody/pos_images/VOC2012/test_coco.json"
    res_json_file = '/data/DigitalBody/pos_images/VOC2012/work_dirs/result_file_12.pkl.bbox.json'
    final_res_dir = "/data/DigitalBody/prediction_result/20191119_nms.3_p.05/"
    ...
    for kfb_name in bboxes_dict:
        print(kfb_name, bboxes_dict[kfb_name][-1])
